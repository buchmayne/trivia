...
class Command(BaseCommand):
    ...
    def get_question_data(self, question) -> Dict[str, Any]:
        ...
        data = {
            ...
            } if question.game_round else None,
            'answers': [{
                'text': answer.text,
        ...
        try:
            ...
            if filename.endswith('db_initial_data.json'):
                ...
                game_lookup = {
                    ...
                    for entry in data if entry['model'] == 'quiz.game'
                }
                category_lookup = {
                    entry['pk']: entry['fields']['name']
                    for entry in data if entry['model'] == 'quiz.category'
                }
                question_type_lookup = {
                    entry['pk']: entry['fields']['name']
                    for entry in data if entry['model'] == 'quiz.questiontype'
                }
                round_lookup = {
                    entry['pk']: {
                    ...
                    for entry in data if entry['model'] == 'quiz.questionround'
                }
                ...
                for entry in data:
                    if entry['model'] == 'quiz.question':
                        ...
                        processed_fields = {
                            ...
                            'question_type': question_type_lookup.get(fields['question_type']),
