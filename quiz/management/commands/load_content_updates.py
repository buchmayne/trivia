                    ...
                    for game_data in data.get("question_groups", []):
                        game, _ = Game.objects.get_or_create(
                            ...
                            defaults={
                                ...
                                "is_password_protected": game_data.get(
                        ...
                        for question_data in game_data.get("questions", []):
                            ...
                            if question_data.get("round"):
                                game_round, _ = QuestionRound.objects.get_or_create(
                                    ...
                                    defaults={
                                        "round_number": question_data["round"].get(
                                            "round_number", 1
                                        )
                                    },
                                )
                            ...
                            question, created = Question.objects.get_or_create(
                                ...
                                defaults={
                                    ...
                                    "question_image_url": question_data.get(
                                        "question_image_url"
                                    ),
                                    "answer_image_url": question_data.get(
                                        "answer_image_url"
                                    ),
                                    "total_points": question_data.get(
                                        "total_points", 1
                                    ),
                            ...
                            if created:
                                ...
                                for answer_data in question_data.get("answers", []):
                                    question.answers.create(
                                        ...
                                        question_image_url=answer_data.get(
                                            "question_image_url"
                                        ),
                                        ...
                                        answer_image_url=answer_data.get(
                                            "answer_image_url"
                                        ),
                                    )
