...
## TBD. Order the following Wikipedia pages from highest to lowest views in 2024 (1 Point Each).
...
## TBD. For each of the following brand logos, name the decade in which the logo was in use (2 Points Each).
...
## TBD. Match each of the following Manhattan neighborhoods to the image of their approximate boundaries (1 Point Each).
...
## TBD. Order the following U.S. Government Agencies from highest to lowest federal spending (1 Point Each).
...
## TBD. Match the following national parks to the image shown (1 Point Each)
