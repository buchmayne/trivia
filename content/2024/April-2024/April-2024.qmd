...
A. "We've suffered losses, but we've not lost the war."

B. "I have a wish. It as a fear as well - that in my end will be my beginning."

C. "I will never stop fighting for our freedom."

D. "Even if you defeat me...others will rise to defeat your tyranny."

E. "Do not forget what you have learned from our past...From it's lessons, the future is forged."

F. "There's a thin line between being a hero, and being a memory."

G. "Fate rarely calls upon as at a moment of our choosing."

H. "We cannot be sure of having something to live for unless we are willing to die for it."
...
<img src="img/violent_crime_rate.png" width="100%">

# Time

## 16. Order the following world records for competitive eating from longest time to shortest time (1 Point Each)

A. 4 32-ounce bowls of mayonnaise

B. 121 Twinkies -- 6 minutes

C. 29 Waffles (8 oz)

D. 48 Oreos and Half a Gallon of Whole Milk
...
* TO DO:
    ...
    * Google trends (17)
    ----
    ----
    * Music/Listening (20) -- Playlist done, just need to format questions

    * Make it so I upload a list of players, and generate teams that way rather than manually writing it in code
    * Remove text from antartica base photos
    * Change Chadwick Boseman to Jacob Elordi
    * Verify bird's eye view question is a good screen cap
    * Add example for visual pun question to help newbs
