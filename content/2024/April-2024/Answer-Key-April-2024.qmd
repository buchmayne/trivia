...
## 11. For each of the following quotes, is it from Optimus Prime from the Transformers franchise or Che Guevara (1 Point Each)?
...
## 12. Adjust each of the following dollar values to reflect their value in current dollars (2 Points Each)
...
## Connect X to Y in as few degrees as possible

Scoring: 6 Degrees: 3 Points, +2 Points for each fewer degree

<img src="img/actors.png" width="100%">

# First Name Last Name

## 14. Given each clue, solve the word puzzle where the last word of each answer is the first word of the next answer (2 Points Each)

Christopher Nolan Ryan Howard Dean Martin Short Round

##

A. Academy Award winning British director, famous for big blockbuster movies, and nonlinear stories
...
E. Singer, actor, Vegas personality from the 1950s. Known for his friendship with fellow artists Frank Sinatra and Sammy Davis Jr., who together with several others formed the Rat Pack.

F. 74 year old comedic actor, who stars in a Hulu series with another older comedic actor and Selena Gomez
